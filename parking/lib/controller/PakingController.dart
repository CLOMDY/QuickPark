...
import 'package:parking/controller/model/car_model.dart';
...
class ParkingController extends GetxController {
  ...
  void slot9Controller() async {
    slot9.value = CarModel(
      booked: true,
      isParked: true,
      parkingHours: "${parkingTimeInMin.value}",
      name: "${name.text}",
    ...
    while (parkingTime != 0) {
      ...
      parkingTime--;
      print(parkingTime);
      slot9.value.parkingHours = parkingTime.toString();
    }
  ...
  void slot10Controller() async {
    slot10.value = CarModel(
      booked: true,
      isParked: true,
      parkingHours: "${parkingTimeInMin.value}",
      name: "${name.text}",
    ...
    while (parkingTime != 0) {
      ...
      parkingTime--;
      print(parkingTime);
      slot10.value.parkingHours = parkingTime.toString();
    }
